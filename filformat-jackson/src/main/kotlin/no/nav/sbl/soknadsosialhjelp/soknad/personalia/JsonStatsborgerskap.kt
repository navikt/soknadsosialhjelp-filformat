...
public open class JsonStatsborgerskap : Serializable {
  ...
  @get:JsonPropertyDescription("Definert med ISO 3166-1 (alpha-3).")
  ...
  public open fun withKilde(kilde: JsonKilde?): JsonStatsborgerskap {
    this.kilde = kilde
    return this
  }

  public open fun withVerdi(verdi: String?): JsonStatsborgerskap {
    this.verdi = verdi
    return this
  }

  public open fun withAdditionalProperty(name: String, `value`: Any?): JsonStatsborgerskap {
    additionalProperties[name] = value
    return this
  }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is JsonStatsborgerskap) return false
  ...
  override fun toString(): String = "JsonStatsborgerskap(kilde=$kilde, verdi=$verdi, additionalProperties=$additionalProperties)"
}
