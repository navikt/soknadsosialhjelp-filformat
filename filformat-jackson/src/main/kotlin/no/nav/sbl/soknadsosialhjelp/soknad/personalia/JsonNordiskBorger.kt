...
public open class JsonNordiskBorger : Serializable {
  ...
  public open fun withKilde(kilde: JsonKilde?): JsonNordiskBorger {
    this.kilde = kilde
    return this
  }

  public open fun withVerdi(verdi: Boolean?): JsonNordiskBorger {
    this.verdi = verdi
    return this
  }

  public open fun withAdditionalProperty(name: String, `value`: Any?): JsonNordiskBorger {
    additionalProperties[name] = value
    return this
  }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is JsonNordiskBorger) return false
  ...
  override fun toString(): String = "JsonNordiskBorger(kilde=$kilde, verdi=$verdi, additionalProperties=$additionalProperties)"
}
