...
public open class JsonOkonomiOpplysningUtgift : Serializable {
  ...
  public open fun withKilde(kilde: JsonKilde?): JsonOkonomiOpplysningUtgift {
    this.kilde = kilde
    return this
  }

  public open fun withType(type: String?): JsonOkonomiOpplysningUtgift {
    this.type = type
    return this
  }

  public open fun withTittel(tittel: String?): JsonOkonomiOpplysningUtgift {
    this.tittel = tittel
    return this
  }

  public open fun withBelop(belop: Int?): JsonOkonomiOpplysningUtgift {
    this.belop = belop
    return this
  }

  public open fun withOverstyrtAvBruker(overstyrtAvBruker: Boolean?): JsonOkonomiOpplysningUtgift {
    this.overstyrtAvBruker = overstyrtAvBruker
    return this
  }

  public open fun withAdditionalProperty(name: String, `value`: Any?): JsonOkonomiOpplysningUtgift {
    additionalProperties[name] = value
    return this
  }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is JsonOkonomiOpplysningUtgift) return false
  ...
  override fun toString(): String = "JsonOkonomiOpplysningUtgift(kilde=$kilde, type=$type, tittel=$tittel, belop=$belop, overstyrtAvBruker=$overstyrtAvBruker, additionalProperties=$additionalProperties)"
}
