...
public open class JsonHarDeltBosted : Serializable {
  ...
  public open fun withKilde(kilde: JsonKildeBruker?): JsonHarDeltBosted {
    this.kilde = kilde
    return this
  }

  public open fun withVerdi(verdi: Boolean?): JsonHarDeltBosted {
    this.verdi = verdi
    return this
  }

  public open fun withAdditionalProperty(name: String, `value`: Any?): JsonHarDeltBosted {
    additionalProperties[name] = value
    return this
  }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is JsonHarDeltBosted) return false
  ...
  override fun toString(): String = "JsonHarDeltBosted(kilde=$kilde, verdi=$verdi, additionalProperties=$additionalProperties)"
}
