...
public open class JsonBorSammenMed : Serializable {
  ...
  public open fun withKilde(kilde: JsonKildeBruker?): JsonBorSammenMed {
    this.kilde = kilde
    return this
  }

  public open fun withVerdi(verdi: Boolean?): JsonBorSammenMed {
    this.verdi = verdi
    return this
  }

  public open fun withAdditionalProperty(name: String, `value`: Any?): JsonBorSammenMed {
    additionalProperties[name] = value
    return this
  }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is JsonBorSammenMed) return false
  ...
  override fun toString(): String = "JsonBorSammenMed(kilde=$kilde, verdi=$verdi, additionalProperties=$additionalProperties)"
}
