...
import no.nav.sbl.soknadsosialhjelp.innsyn.soker.hendelse.JsonTildeltNavKontor;
import no.nav.sbl.soknadsosialhjelp.innsyn.soker.hendelse.JsonVedtakFattet;
