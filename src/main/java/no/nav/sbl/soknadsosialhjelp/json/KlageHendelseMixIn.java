...
import no.nav.sbl.soknadsosialhjelp.digisos.soker.klage.hendelse.JsonKlageDokumentasjonEtterspurt;

@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "type", visible = true)
@JsonSubTypes({
    @JsonSubTypes.Type(value = JsonKlageStatus.class, name = "klageStatus"),
    @JsonSubTypes.Type(value = JsonKlageDokumentasjonEtterspurt.class, name = "klageDokumentasjonEtterspurt"),
